package mx.mobile.solution.nabia04.main.ui.host_fragments
...
import mx.mobile.solution.nabia04.main.data.repositories.DatabaseRepository
...
import mx.mobile.solution.nabia04.main.ui.activities.ActivityUpdateUserData
import mx.mobile.solution.nabia04.main.ui.activities.MainActivity.Companion.clearance
import mx.mobile.solution.nabia04.main.ui.activities.MainActivity.Companion.databaseViewModel
 ...
 */
class DatabaseHostFragment : BaseDataBindingFragment<DatabaseViewpagerContainerBinding>(), SearchView.OnQueryTextListener{
    ...
    private fun setBirthDayPerson(list: List<EntityUserData>) {
    ...
    private fun observeDataChange() { databaseViewModel.data.observe(viewLifecycleOwner) {
    ...
    private fun upDateDataBaseStatistics(filteredData: List<EntityUserData>, type: Int) =
        object : BackgroundTasks() {
            var maleCount = 0
            var femaleCount = 0
            var noneCount = 0
