...
import mx.mobile.solution.nabia04_beta1.databinding.FragmentDatabaseDetailBinding
...
@AndroidEntryPoint
class FragmentCurrentMembersDetail : Fragment() {
    ...
    private var _binding: FragmentDatabaseDetailBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDatabaseDetailBinding.inflate(inflater, container, false)
        return binding.root
    }
        ...
        if (clearance == Const.POS_PRO || userFolioNumber == "13786") {
            AlertDialog.Builder(requireContext(), R.style.AppCompatAlertDialogStyle)
                ...
                .setPositiveButton("Continue") { dialog, id ->
                    ...
                    v.findViewById<View>(R.id.authorize_user)
                        .setOnClickListener(OnClearanceItemClick(Const.AUTHORIZED, alert))
                }
