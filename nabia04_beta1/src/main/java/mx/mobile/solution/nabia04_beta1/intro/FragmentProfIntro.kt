 ...
 */
class FragmentProfIntro : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.progress.setImageDrawable(
            AppCompatResources.getDrawable(
                requireContext(),
                R.drawable.progres_dot_5
            )
        )

        binding.intro.text = "PROFESSIONAL HELP"

        binding.text.text = resources.getText(R.string.prof_intro_text)

        binding.text.textSize = 19f
