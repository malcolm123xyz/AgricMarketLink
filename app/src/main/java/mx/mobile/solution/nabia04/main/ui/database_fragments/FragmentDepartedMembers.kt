...
import mx.mobile.solution.nabia04.main.ui.activities.MainActivity.Companion.databaseLoadingStatus
...
class FragmentDepartedMembers : BaseFragment<ListFragmentBinding>() {
    ...
    private fun listenForLoadingStatus() {
        databaseLoadingStatus.value.observe(
            viewLifecycleOwner
        ) { loadingStatus -> showProgress(loadingStatus.isTrue) }
    }
