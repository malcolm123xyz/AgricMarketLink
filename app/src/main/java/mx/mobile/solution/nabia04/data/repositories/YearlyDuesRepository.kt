...
import mx.mobile.solution.nabia04.ui.host_fragments.TreasurerPaymentDetailHost.Companion.SELECTED_YEAR
...
class YearlyDuesRepository(context: Context) {
    ...
    companion object {
        ...
        private var dues: MutableList<mx.mobile.solution.nabia04.data.entities.EntityYearlyDues>? =
            null
        private var dao: mx.mobile.solution.nabia04.data.dao.DuesDetailDao? = null
    }
