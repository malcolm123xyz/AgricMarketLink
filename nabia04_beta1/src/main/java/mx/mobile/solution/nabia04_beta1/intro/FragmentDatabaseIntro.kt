 ...
 */
class FragmentDatabaseIntro : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.progress.setImageDrawable(
            AppCompatResources.getDrawable(
                requireContext(),
                R.drawable.progres_dot_3
            )
        )

        binding.intro.text = "DATABASE"

        binding.text.text = resources.getText(R.string.database_intro_text)
