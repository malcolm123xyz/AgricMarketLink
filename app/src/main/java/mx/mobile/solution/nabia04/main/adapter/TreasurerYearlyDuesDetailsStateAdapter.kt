...
import mx.mobile.solution.nabia04.main.fragments.welfare.treasurer.FragmentYearlyDues
...
class TreasurerYearlyDuesDetailsStateAdapter(
    ...
    override fun getItemCount(): Int = excelHelper.getWorkbook().numberOfSheets
