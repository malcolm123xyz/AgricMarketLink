 ...
 */
class FragmentNoticeBoardIntro : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.progress.setImageDrawable(
            AppCompatResources.getDrawable(
                requireContext(),
                R.drawable.progres_dot_2
            )
        )

        binding.intro.text = "NOTICE BOARD"

        binding.text.text = resources.getText(R.string.noticeboard_intro_text)
